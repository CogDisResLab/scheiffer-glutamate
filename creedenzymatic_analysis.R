...
krsa_files <- c("results/withinChip_KRSA_Table_GLU_VEH.csv")

uka_files <- c("kinome_data/UKA/Summaryresults 20220406-1355.txt")

peptide_files <- c("results/dpp_GLU_VEH-STK.csv")
